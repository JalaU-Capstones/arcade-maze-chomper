...
public class CollisionDetector : ICollisionDetector
{
    ...
    /// <summary>
    /// Check if Arcade Maze Chomper collides with any ghost
    /// </summary>
    ...
    /// <summary>
    /// Check if Arcade Maze Chomper collides with a collectible
    /// </summary>
    public Collectible? CheckPacmanCollectibleCollision(Pacman pacman, List<Collectible> collectibles)
    {
        // Find active collectibles at Arcade Maze Chomper's position
    ...
    public bool CanMoveTo(Entity entity, int newRow, int newCol, TileType[,] map)
    {
        ...
        if (tile == TileType.GhostDoor)
        {
            ...
            // Arcade Maze Chomper cannot pass through ghost doors
            return false;
        }
