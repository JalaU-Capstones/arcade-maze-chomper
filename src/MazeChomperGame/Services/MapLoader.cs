...
namespace MazeChomperGame.Services;
...
public class MapLoader : IMapLoader
{
    ...
    private string GetAssetsBasePath()
    {
        ...
        {
            // Flatpak: Assets are in /app/share/arcade-maze-chomper/Assets
            return "/app/share/arcade-maze-chomper/Assets";
        }
    ...
    /// <summary>
    /// Get Arcade Maze Chomper's starting position from the map
    /// </summary>
    public (int Row, int Col) GetPacmanSpawn(string fileName)
    {
        ...
        var ex = new InvalidOperationException($"Arcade Maze Chomper spawn point '{Constants.PacmanChar}' not found in map {fileName}");
        _logger.LogError(ex, $"Error finding Arcade Maze Chomper spawn in {fileName}");
        throw ex;
    }
