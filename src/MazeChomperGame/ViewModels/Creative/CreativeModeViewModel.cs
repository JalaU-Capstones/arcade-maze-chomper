...
using MazeChomperGame.Services.KeyBindings;
using MazeChomperGame.ViewModels;
using ReactiveUI;

namespace MazeChomperGame.ViewModels.Creative;
...
public class CreativeModeViewModel : ViewModelBase
{
    ...
    private async Task ExportProjectAsync()
    {
        ...
        {
            Title = "Export Arcade Maze Chomper Project",
            SuggestedFileName = fileName,
            DefaultExtension = ".pacproj",
            FileTypeChoices = new[]
            {
                new FilePickerFileType("Arcade Maze Chomper Project")
                {
    ...
    private async Task OpenImportPreviewAsync()
    {
        ...
        {
            Title = "Import Arcade Maze Chomper Project",
            AllowMultiple = false,
            FileTypeFilter = new[]
            {
                new FilePickerFileType("Arcade Maze Chomper Project")
    ...
    private async Task ImportAndPlayAsync()
    {
        ...
        try
        {
            ...
            var tempDir = Path.Combine(Path.GetTempPath(), "arcade-maze-chomper-import-play");
    ...
    private Task PlayTestAsync()
    {
        ...
        var tempDir = Path.Combine(Path.GetTempPath(), "arcade-maze-chomper-playtest");
        Directory.CreateDirectory(tempDir);
    ...
    private IEnumerable<string> ValidateLayout()
    {
        ...
        {
            errors.Add("Arcade Maze Chomper spawn is missing.");
        }
