...
using ReactiveUI;
using Direction = MazeChomperGame.Shared.Direction;
using MazeChomperGame.Models.Entities;
using Microsoft.Extensions.DependencyInjection;

namespace MazeChomperGame.ViewModels;
...
public class MultiplayerGameViewModel : ViewModelBase
{
    ...
    {
        PlayerRole.Pacman => "YOU ARE: CHOMPER",
        PlayerRole.Blinky => "YOU ARE: RED",
        PlayerRole.Pinky => "YOU ARE: PINK",
        PlayerRole.Inky => "YOU ARE: CYAN",
        PlayerRole.Clyde => "YOU ARE: ORANGE",
    ...
    {
        PlayerRole.Pacman => "Objective: Collect all dots and complete 3 levels. Avoid enemies!",
        PlayerRole.Blinky or PlayerRole.Pinky or PlayerRole.Inky or PlayerRole.Clyde =>
            "Objective: Catch the Chomper! Make them lose all 3 lives.",
    ...
    public string GameOverMessage => _myRole switch
    {
        ...
        PlayerRole.Spectator => "Arcade Maze Chomper lost all lives.",
        _ => "You caught Arcade Maze Chomper!"
    };
    ...
    private void HandleGameStateUpdate(GameStateMessage state)
    {
        ...
        // Update Arcade Maze Chomper (if it exists in the game)
    ...
    private void HandleGameEvent(GameEventMessage evt)
    {
        switch (evt.EventType)
        {
            ...
            case GameEventType.LevelComplete:
                ...
                // For multiplayer level 1 only, this is victory for Arcade Maze Chomper.
