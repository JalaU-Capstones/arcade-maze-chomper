namespace MazeChomperGame.Helpers;
...
{
    // Multiplayer
    public const string MultiplayerServerIP = "pacmanserver.codewithbotina.com"; // Replace with your server IP
    ...
    // Arcade Maze Chomper should be slightly faster than ghosts in straight lines.
    ...
    // Kept for backwards-compatibility; initial Arcade Maze Chomper speed before per-level config.
