...
class Program
{
    ...
    private static void CreateWindowsShortcuts(ILogger logger)
    {
        ...
        var flagPath = Path.Combine(
            ...
            "ArcadeMazeChomper", "shortcuts_created.flag"
        );
        ...
        try
        {
            ...
            // %APPDATA%\Microsoft\Windows\Start Menu\Programs\Arcade Maze Chomper\
            var startMenuProgramsRoot = Path.Combine(
                Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData),
                "Microsoft", "Windows", "Start Menu", "Programs"
            );
            var startMenuPath = Path.Combine(startMenuProgramsRoot, "Arcade Maze Chomper");
            ...
            Directory.CreateDirectory(startMenuPath);
                ...
                CreateShortcut(shell, desktopPath, "Arcade Maze Chomper.lnk", logger);
                CreateShortcut(shell, startMenuPath, "Arcade Maze Chomper.lnk", logger);
