...
using MazeChomperGame.Server.Services;
using Microsoft.Extensions.Logging;
using System.Linq;
using System.Collections.Generic;
using System;

namespace MazeChomperGame.Server;
...
public class RelayServer : INetEventListener
{
    ...
    private void HandleLeaveRoomRequest(Player player)
    {
        ...
        if (room != null)
        {
            ...
            else
            {
                ...
                // Ensure Arcade Maze Chomper always exists (critical for a playable match).
    ...
    private void EnsurePacmanAssigned(Room room, string previousPlayerName)
    {
        ...
        _logger.LogWarning("Arcade Maze Chomper role was missing; reassigned Arcade Maze Chomper to {PlayerName} (Room {RoomId}).", candidate.Name, room.Id);
    ...
    private void NormalizeRolesForStart(Room room)
    {
        ...
        // Ensure a single Arcade Maze Chomper.
    ...
    private void HandleStartGameRequest(Player player)
    {
        ...
        if (room != null && player.IsAdmin)
        {
            ...
            // Ensure roles are valid and Arcade Maze Chomper exists before starting.
    ...
    private void HandleRestartGameRequest(Player player)
    {
        ...
        if (room != null && player.IsAdmin)
        {
            ...
            // Deterministic role rotation: ensures exactly one Arcade Maze Chomper after restart.
    ...
    public void OnConnectionRequest(ConnectionRequest request) => request.AcceptIfKey("MazeChomperGame");
}
